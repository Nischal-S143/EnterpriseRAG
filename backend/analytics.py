        ...
        with get_db_session() as db:
            ...
            if user:
                ...
                if latest:
                    ...
                    latest.duration_seconds = int(
                        (latest.end_time - latest.start_time).total_seconds())
    except Exception as e:
    ...
    try:
        ...
        with get_db_session() as db:
            ...
            avg_session = db.query(func.avg(AnalyticsSession.duration_seconds)).filter(
                AnalyticsSession.end_time.isnot(None),
...
class Strategist:
    ...
    def analyze_low_confidence_queries(self):
        ...
        queries_json = json.dumps(low_conf_queries, indent=2)
        prompt = (
            "Analyze these low-confidence or flagged user queries"
            " and suggest improvements to the knowledge base"
